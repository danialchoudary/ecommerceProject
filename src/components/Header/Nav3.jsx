  ...
  <div className="h-69px w-full flex justify-center items-center ">
    <div className="h-36px w-11/12 flex justify-evenly flex-wrap gap-y-2 gap-x-1 lg:gap-x-0">
      {categories.map((category, index) => (
        <div
          key={index}
          className="flex gap-2 rounded-full p-4 bg-sky-100 justify-center items-center hover:bg-blue-400 cursor-pointer hover:text-white active:bg-blue-400 active:text-white category-list"
